...
def sign_up_get(name,email,dob_day,dob_month,dob_year,contact):
    # Simple validation
    if not name or not email or not dob_day or not dob_month or not dob_year or not contact:
...
def signup():
    ...
    # Sign-up button
    sign_up_button = ctk.CTkButton(root, text="Sign Up", font=('Arial Bold', 16), width=247, height=30, bg_color="#FFAB40", corner_radius=10, command=sign_up_get)
