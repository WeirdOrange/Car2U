...
bg_image_path = r"C:\Users\chewy\OneDrive\Car rental\Booking Details.png"
...
try:
    ...
    root.car_photo = car_photo  # Prevent garbage collection
...
# Call this function where needed, e.g., after confirming the booking request
...
request_booking_button = tk.Button(root, text="REQUEST BOOKING", font=("Arial", 19, "bold"), bd=0, width=17, bg="#FF865A", fg="black", command=request_booking)
request_booking_button.place(x=513, y=645)  # Adjust the coordinates as needed
