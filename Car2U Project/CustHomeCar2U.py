...
def homepage(login_callback,uprent_callback,list_callback,profile_callback,about_callback,review_callback,chat_callback):
    ...
    contact_us_button = ctk.CTkButton(master=homeFrame, text="Contact Us", width=120, fg_color=("#FB543F","#FC503E"), bg_color="#FC503E", 
                                      text_color="#000000", font=("Tw Cen MT Condensed Extra Bold", 20), command=lambda:open_chat(homeFrame, chat_callback))
    ...
    upRenter_label = ctk.CTkButton(master=homeFrame, text="Upgrade to Rental Agent", bg_color="#2A333D", fg_color="#2A333D", text_color="#9EA3A9", 
                                  font=("Tw Cen MT Condensed Extra Bold", 20),
